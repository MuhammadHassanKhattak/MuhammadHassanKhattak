...
function Obj1(name1, gender, address, education, profession) {
    this.name1 = name1;
    this.gender = gender;
...
submit.addEventListener("click", function () {
    var userData = Obj1(name1.Value, gender.Value, address.Value, education.Value, profession.Value);
    edrray.push(userData)
